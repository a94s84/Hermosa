    ...
    <div class="defaultWrap">
      ...
      >
        <swiper-slide>
          ...
          >
            <picture>
              <source
                srcset="../../assets/img/banner1.png"
                media="(min-width: 1007px)"
              />
              <img src="../../assets/img/banner_m1.png" />
            </picture>
          </router-link>
        </swiper-slide>
        <swiper-slide>
          ...
          >
            <picture>
              <source
                srcset="../../assets/img/banner2.png"
                media="(min-width: 1007px)"
              />
              <img src="../../assets/img/banner_m2.png" />
            </picture>
          </router-link>
        </swiper-slide>
      </swiper>
      <section class="wrap newsIn">
        ...
        <swiper
          ...
          :navigation="true"
          :loop="true"
          :breakpoints="{ 768: { slidesPerView: 3, spaceBetween: 35 } }"
          class="newinSlide"
        >
          <swiper-slide
            class="pdbox"
            v-for="item in products.slice(-6)"
            :key="item.id"
          >
